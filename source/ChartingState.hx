...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var arrowStyleDropDown:FlxUIDropDownMenuCustom = new FlxUIDropDownMenuCustom(320, noteSkinInputText.y, FlxUIDropDownMenuCustom.makeStrIdLabelArray(arrowStyleList, true), function(arrowStyle:String)
		{
